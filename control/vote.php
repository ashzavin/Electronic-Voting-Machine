        ...
        <div class="widget-box">
         ...
         <form class="form-horizontal" method="get" action="" name="basic_validate" id="basic_validate" novalidate="novalidate">
              ...
              <div class="form-actions">
                <button style="margin-left:180px; margin-bottom:20px; button-size:200px;" type="submit" name="he" class="btn btn-success">Vote For</button>
              </div>
            </form>
          </div>
        </div>';
				...
				if(isset($_GET['he'])){
					...
					//$data='5';
					$sql_query = "select name,nid,reg,matched,address,age,time,img from temp where nid like '$data';";
