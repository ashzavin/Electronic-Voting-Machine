        ...
        <div class="widget-box">
         ...
         <form class="form-horizontal" method="get" action="" name="basic_validate" id="basic_validate" novalidate="novalidate">
              ...
              <div class="form-actions">
                <button style="margin-left:180px; margin-bottom:20px; button-size:200px;" type="submit" name="he1" class="btn btn-success">Show Results</button>
              </div>
            </form>
          </div>
        </div>';
				...
				<h4 style="color:#FE2E64;">Winner</h4>
				</div>
				</div>
